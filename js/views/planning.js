...
import { el, clear, isoDate, getMonday, addDays, formatDayShort, formatDate, debounce, toast, displayStagiaire, compareByNom } from "../utils.js?v=20260716a";
import { icon } from "../icons.js?v=20260716a";
import { ACTIVITES, ACTIVITY_SHAPES, JOURS, HALF_DAYS, RESULTATS } from "../config.js?v=20260716a";
...
import { openBenevolesPanel } from "./benevoles.js?v=20260716a";
