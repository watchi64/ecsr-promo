...
} from "../db.js?v=20260630g";
import { el, clear, isoDate, getMonday, addDays, formatDayShort, formatDate, debounce, toast, displayStagiaire } from "../utils.js?v=20260630g";
import { icon } from "../icons.js?v=20260630g";
import { ACTIVITES, ACTIVITY_SHAPES, JOURS, HALF_DAYS, RESULTATS } from "../config.js?v=20260630g";
import { isAdmin, getAdminEmail } from "../auth-admin.js?v=20260630g";
