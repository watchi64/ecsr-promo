 ...
 */
import { listAgendaEvents } from "../db.js?v=20260731p";
import { el, clear, parseDate, formatDate, isoDate } from "../utils.js?v=20260731p";
import { icon } from "../icons.js?v=20260731p";
import { isAdmin, getProfile, getProfileWho } from "../auth-admin.js?v=20260731p";
