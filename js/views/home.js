 ...
 */
import { listAgendaEvents } from "../db.js?v=20260719h";
import { el, clear, parseDate, formatDate, isoDate } from "../utils.js?v=20260719h";
import { icon } from "../icons.js?v=20260719h";
import { isAdmin, getProfile, getProfileWho } from "../auth-admin.js?v=20260719h";
