  ...
  container.appendChild(el("section", { class: "home-section" },
    ...
    el("div", { class: "home-cols" },
      ...
      el("div", { class: "home-feature" },
        ...
        el("h3", {}, "Notes & évaluations"),
        el("p", {}, "Suivre la progression de chaque stagiaire — thèmes, compétences, contrôles. Moyennes calculées automatiquement."),
      ),
      el("div", { class: "home-feature" },
  ...
  container.appendChild(el("section", { class: "home-section" },
    ...
    el("div", { class: "home-rules" },
      ...
      el("article", { class: "home-rule" },
        ...
        el("p", { class: "muted" }, "Tu peux changer d'identité à tout moment dans Paramètres → Mon identité."),
      ),
      el("article", { class: "home-rule" },
        el("div", { class: "home-rule-badge" }, "📅"),
      ...
      el("article", { class: "home-rule" },
        el("div", { class: "home-rule-badge" }, "🛡️"),
        el("h3", {}, "Anti-tricherie sur les dates"),
        el("p", {}, "Les non-admins ne peuvent ajouter un passage que sur les 2 derniers jours. Au-delà, seuls les admins peuvent intervenir."),
      ),
    ),
  ));
  ...
  container.appendChild(el("section", { class: "home-section home-section-quickstart" },
    ...
    el("ol", { class: "home-steps" },
      el("li", {},
        ...
        " — première visite uniquement. Sélectionne ton prénom dans la liste."
      ),
      el("li", {},
