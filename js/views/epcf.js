...
import { listStagiaires, listProfs, listEpcf, upsertEpcf, getEpcfMoyennes } from "../db.js?v=20260726b";
import { el, clear, isoDate, formatDate, displayStagiaire, compareByNom, toast } from "../utils.js?v=20260726b";
import { isAdmin, isProf, getProfile } from "../auth-admin.js?v=20260726b";
import { getCurrentWho } from "../identity.js?v=20260726b";
import { EPCF_TRAMES, NOTE_LABELS } from "../epcf-trames.js?v=20260726b";
import { renderEpcfTrameSection, renderEpcfClasse } from "../epcf-restitution.js?v=20260726b";
