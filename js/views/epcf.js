...
import { listStagiaires, listProfs, listEpcf, upsertEpcf, getEpcfMoyennes } from "../db.js?v=20260729d";
import { el, clear, isoDate, formatDate, displayStagiaire, compareByNom, toast } from "../utils.js?v=20260729d";
import { isAdmin, isProf, getProfile } from "../auth-admin.js?v=20260729d";
import { getCurrentWho } from "../identity.js?v=20260729d";
import { EPCF_TRAMES, NOTE_LABELS } from "../epcf-trames.js?v=20260729d";
import { renderEpcfTrameSection, renderEpcfClasse } from "../epcf-restitution.js?v=20260729d";
