import { listStagiaires, getStats, getSetting } from "../db.js?v=20260713l";
import { el, clear, isoDate, getMonday, displayStagiaire, compareByNom } from "../utils.js?v=20260713l";
import { icon } from "../icons.js?v=20260713l";
import { renderPassages } from "./passages.js?v=20260713l";
