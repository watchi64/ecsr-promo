import { listStagiaires, getStats, getSetting } from "../db.js?v=20260731n";
import { el, clear, isoDate, getMonday, displayStagiaire, compareByNom } from "../utils.js?v=20260731n";
import { icon } from "../icons.js?v=20260731n";
import { renderPassages } from "./passages.js?v=20260731n";
