import { listStagiaires, listEvaluations, getStats, getSetting } from "../db.js?v=20260630h";
import { el, clear, isoDate, getMonday, displayStagiaire, compareByNom } from "../utils.js?v=20260630h";
