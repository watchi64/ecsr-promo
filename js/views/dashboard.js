import { listStagiaires, getStats, getSetting } from "../db.js?v=20260723a";
import { el, clear, isoDate, getMonday, displayStagiaire, compareByNom } from "../utils.js?v=20260723a";
import { icon } from "../icons.js?v=20260723a";
import { renderPassages } from "./passages.js?v=20260723a";
