import { listStagiaires, listEvaluations, getPlanning, getHalfMetaForWeek, getJoursOff, getSetting,
         getVoitureAggregats, listProfs, listEpcf, getEpcfMoyennes, listThemes } from "../db.js?v=20260717c";
import { el, clear, isoDate, getMonday, addDays, formatDate, displayStagiaire, compareByNom } from "../utils.js?v=20260717c";
import { HALF_DAYS } from "../config.js?v=20260717c";
import { isAdmin, getProfile } from "../auth-admin.js?v=20260717c";
import { renderEpcfTrameSection } from "../epcf-restitution.js?v=20260717c";
import { renderSubTabs } from "../subtabs.js?v=20260717c";
