import { listStagiaires, listPassages, addPassage, updatePassage, deletePassage, listRecentPassagesAudit } from "../db.js?v=20260916a";
import { el, clear, isoDate, formatDate, toast, displayStagiaire } from "../utils.js?v=20260916a";
import { icon } from "../icons.js?v=20260916a";
import { recordUndo } from "../undo.js?v=20260916a";
import { TYPES, RESULTATS } from "../config.js?v=20260916a";
import { isAdmin, getProfile } from "../auth-admin.js?v=20260916a";
