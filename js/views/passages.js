import { listStagiaires, listPassages, addPassage, updatePassage, deletePassage, listRecentPassagesAudit } from "../db.js?v=20260731p";
import { el, clear, isoDate, formatDate, toast, displayStagiaire } from "../utils.js?v=20260731p";
import { icon } from "../icons.js?v=20260731p";
import { recordUndo } from "../undo.js?v=20260731p";
import { TYPES, RESULTATS } from "../config.js?v=20260731p";
import { isAdmin, getProfile } from "../auth-admin.js?v=20260731p";
