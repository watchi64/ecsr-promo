import { listStagiaires, listPassages, addPassage, updatePassage, deletePassage, listRecentPassagesAudit } from "../db.js?v=20260701a";
import { el, clear, isoDate, formatDate, toast, displayStagiaire } from "../utils.js?v=20260701a";
import { icon } from "../icons.js?v=20260701a";
import { recordUndo } from "../undo.js?v=20260701a";
import { TYPES, RESULTATS } from "../config.js?v=20260701a";
import { isAdmin, getProfile } from "../auth-admin.js?v=20260701a";
import { getCurrentWho } from "../identity.js?v=20260701a";
