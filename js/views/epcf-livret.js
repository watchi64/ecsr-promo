...
import { listStagiaires, listProfs, listEpcfLivrets, getEpcfLivret, upsertEpcfLivret } from "../db.js?v=20260723h";
import { el, clear, displayStagiaire, compareByNom, formatDate, toast } from "../utils.js?v=20260723h";
