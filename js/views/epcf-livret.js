...
import { listStagiaires, listEpcfLivrets, getEpcfLivret, upsertEpcfLivret } from "../db.js?v=20260719f";
import { el, clear, displayStagiaire, compareByNom, formatDate, toast } from "../utils.js?v=20260719f";
