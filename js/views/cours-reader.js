...
import { carteSignal, signalConnu } from "../signaux.js?v=20260809b";
import { carteMarquage, marquageConnu } from "../marquage.js?v=20260809b";
import { listCoursIndex, getCours } from "../db.js?v=20260809b";
import { isAdmin, isProf } from "../auth-admin.js?v=20260809b";
import { titreDepuisMarkdown, tempsLecture } from "../cours-rules.js?v=20260809b";
...
export async function openCoursSheet(theme) {
  ...
  const modifier = (isAdmin() || isProf())
    ? el("button", { class: "btn cours-modifier", type: "button", onClick: async () => {
        const { openCoursEditeur } = await import("./cours-editeur.js?v=20260809b");
        close();
