 ...
 */
import { el, clear } from "../utils.js?v=20260915a";
import { icon } from "../icons.js?v=20260915a";
import { carteSignal, signalConnu } from "../signaux.js?v=20260915a";
import { carteMarquage, marquageConnu } from "../marquage.js?v=20260915a";
import { listCoursIndex, getCours } from "../db.js?v=20260915a";
import { isAdmin, isProf } from "../auth-admin.js?v=20260915a";
import { titreDepuisMarkdown, tempsLecture } from "../cours-rules.js?v=20260915a";
...
export async function openCoursSheet(theme, { onQcm } = {}) {
  ...
  const modifier = (isAdmin() || isProf())
    ? el("button", { class: "btn cours-modifier", type: "button", onClick: async () => {
        const { openCoursEditeur } = await import("./cours-editeur.js?v=20260915a");
        close();
