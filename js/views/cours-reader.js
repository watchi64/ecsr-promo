...
import { carteSignal, signalConnu } from "../signaux.js?v=20260811d";
import { carteMarquage, marquageConnu } from "../marquage.js?v=20260811d";
import { listCoursIndex, getCours } from "../db.js?v=20260811d";
import { isAdmin, isProf } from "../auth-admin.js?v=20260811d";
import { titreDepuisMarkdown, tempsLecture } from "../cours-rules.js?v=20260811d";
...
export async function openCoursSheet(theme, { onQcm } = {}) {
  ...
  const modifier = (isAdmin() || isProf())
    ? el("button", { class: "btn cours-modifier", type: "button", onClick: async () => {
        const { openCoursEditeur } = await import("./cours-editeur.js?v=20260811d");
        close();
