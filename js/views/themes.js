import { listThemes, updateTheme, addTheme, deleteTheme, listQcmIndex, getQcmFull, publishQcm, unpublishQcm, updateExamConfig, listExamAttempts, resetExamAttempt, listMyQcmAttempts, getMyProfile, listEvaluations, getOrCreateQcm, saveQcmQuestion, deleteQcmQuestion, reorderQcmQuestions, uploadQcmImage } from "../db.js?v=20260719p";
import { el, clear, isoDate, formatDate, toast, debounce } from "../utils.js?v=20260719p";
import { icon } from "../icons.js?v=20260719p";
import { isAdmin, getAdminEmail, isFounder, getViewAs, isProf, isStagiaire } from "../auth-admin.js?v=20260719p";
import { recordUndo } from "../undo.js?v=20260719p";
import { openQcmEntrainement, openQcmExamen } from "./qcm.js?v=20260719p";
