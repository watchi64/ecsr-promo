import { listThemes, updateTheme, addTheme, deleteTheme, listQcmIndex, getQcmFull, publishQcm, unpublishQcm, updateExamConfig, listExamAttempts, resetExamAttempt, listMyQcmAttempts, getMyProfile, listEvaluations, getOrCreateQcm, saveQcmQuestion, deleteQcmQuestion, reorderQcmQuestions, uploadQcmImage, listQcmSignalements, setQcmSignalementStatut, countQcmSignalementsOuverts } from "../db.js?v=20260915d";
import { el, clear, isoDate, formatDate, toast, debounce } from "../utils.js?v=20260915d";
import { icon } from "../icons.js?v=20260915d";
import { examenDemarrable, tempsRestantMs, formatTempsRestant,
         echeanceDepuisChoix, DUREES_OUVERTURE } from "../qcm-exam-rules.js?v=20260915d";
import { isAdmin, getAdminEmail, isProf, isStagiaire } from "../auth-admin.js?v=20260915d";
import { recordUndo } from "../undo.js?v=20260915d";
import { openQcmEntrainement, openQcmExamen } from "./qcm.js?v=20260915d";
import { carteSignalement, renderConsoleSignalements, chargerAuteurs } from "./signalements.js?v=20260915d";
import { renderSubTabs } from "../subtabs.js?v=20260915d";
import { hasCours, openCoursSheet, chargerCoursIndex, coursDejaOuvert } from "./cours-reader.js?v=20260915d";
