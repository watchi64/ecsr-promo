import { listThemes, updateTheme, addTheme, deleteTheme, listQcmIndex, getQcmFull, publishQcm, unpublishQcm, updateExamConfig, listExamAttempts, resetExamAttempt, listMyQcmAttempts, getMyProfile, listEvaluations, getOrCreateQcm, saveQcmQuestion, deleteQcmQuestion, reorderQcmQuestions, uploadQcmImage } from "../db.js?v=20260720d";
import { el, clear, isoDate, formatDate, toast, debounce } from "../utils.js?v=20260720d";
import { icon } from "../icons.js?v=20260720d";
import { isAdmin, getAdminEmail, isFounder, getViewAs, isProf, isStagiaire } from "../auth-admin.js?v=20260720d";
import { recordUndo } from "../undo.js?v=20260720d";
import { openQcmEntrainement, openQcmExamen } from "./qcm.js?v=20260720d";
