 ...
 */
import { el, clear, debounce } from "../utils.js?v=20260916a";
...
import { getCours, saveCours, setCoursPublie, listCoursVersions, getCoursVersion, uploadCoursImage }
  from "../db.js?v=20260916a";
import { rendreMarkdown } from "./cours-reader.js?v=20260916a";
import { insererSyntaxe, titreDepuisMarkdown, cheminImage, interpolerAncres } from "../cours-rules.js?v=20260916a";
import { getProfileWho } from "../auth-admin.js?v=20260916a";
import { reduireImage } from "../cours-images.js?v=20260916a";
import { SIGNAUX, carteSignal } from "../signaux.js?v=20260916a";
import { CATALOGUE } from "../signaux-catalogue.js?v=20260916a";
import { MARQUAGES, carteMarquage } from "../marquage.js?v=20260916a";
