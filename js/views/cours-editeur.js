 ...
 */
import { el, clear, debounce } from "../utils.js?v=20260916b";
...
import { getCours, saveCours, setCoursPublie, listCoursVersions, getCoursVersion, uploadCoursImage }
  from "../db.js?v=20260916b";
import { rendreMarkdown } from "./cours-reader.js?v=20260916b";
import { insererSyntaxe, titreDepuisMarkdown, cheminImage, interpolerAncres } from "../cours-rules.js?v=20260916b";
import { getProfileWho } from "../auth-admin.js?v=20260916b";
import { reduireImage } from "../cours-images.js?v=20260916b";
import { SIGNAUX, carteSignal } from "../signaux.js?v=20260916b";
import { CATALOGUE } from "../signaux-catalogue.js?v=20260916b";
import { MARQUAGES, carteMarquage } from "../marquage.js?v=20260916b";
