...
import { listStagiaires, listDpDossiers, getDpDossier, upsertDpDossier } from "../db.js?v=20260918a";
import { el, clear, displayStagiaire, compareByNom, formatDate, toast } from "../utils.js?v=20260918a";
...
import { collectData, fillData, applyEditable, wireDocEditing,
         bindDocPrint, refreshDocPrint, teardownDocPrint } from "../doc-officiel.js?v=20260918a";
import { buildDpFlux, blocSommaire, feuille } from "./dp-gabarit.js?v=20260918a";
import { exempleImprime } from "../dp-rules.js?v=20260918a";
import { composer, marquerCoupures } from "../dp-pagination.js?v=20260918a";
