...
import { listStagiaires, listDpDossiers, getDpDossier, upsertDpDossier } from "../db.js?v=20260810f";
import { el, clear, displayStagiaire, compareByNom, formatDate, toast } from "../utils.js?v=20260810f";
...
import { collectData, fillData, applyEditable, wireDocEditing,
         bindDocPrint, refreshDocPrint, teardownDocPrint } from "../doc-officiel.js?v=20260810f";
import { buildDpHTML } from "./dp-gabarit.js?v=20260810f";
import { blocsImprimes } from "../dp-rules.js?v=20260810f";
