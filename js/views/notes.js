...
import { el, clear, isoDate, formatDate, toast, displayStagiaire, compareByNom } from "../utils.js?v=20260719h";
import { icon } from "../icons.js?v=20260719h";
import { getAdminEmail, isAdmin } from "../auth-admin.js?v=20260719h";
import { recordUndo } from "../undo.js?v=20260719h";
import { renderSubTabs } from "../subtabs.js?v=20260719h";
import { renderEpcf } from "./epcf.js?v=20260719h";
import { renderEpcfLivret } from "./epcf-livret.js?v=20260719h";
