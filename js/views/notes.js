...
import { el, clear, isoDate, formatDate, toast, displayStagiaire, compareByNom } from "../utils.js?v=20260718d";
import { icon } from "../icons.js?v=20260718d";
import { getAdminEmail, isAdmin } from "../auth-admin.js?v=20260718d";
