...
import { el, clear, isoDate, formatDate, toast, displayStagiaire, compareByNom } from "../utils.js?v=20260709e";
import { icon } from "../icons.js?v=20260709e";
import { getAdminEmail, isAdmin } from "../auth-admin.js?v=20260709e";
