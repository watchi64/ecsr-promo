...
import { el, clear, isoDate, formatDate, toast, displayStagiaire, compareByNom } from "../utils.js?v=20260809f";
import { icon } from "../icons.js?v=20260809f";
import { getAdminEmail, isAdmin } from "../auth-admin.js?v=20260809f";
import { recordUndo } from "../undo.js?v=20260809f";
import { renderSubTabs } from "../subtabs.js?v=20260809f";
import { renderEpcf } from "./epcf.js?v=20260809f";
import { renderEpcfLivret } from "./epcf-livret.js?v=20260809f";
