...
import { supabase } from "./db.js?v=20260915a";
import { icon } from "./icons.js?v=20260915a";
import { fenetreMessages, pageDepuisHash, extraireEvenements } from "./chatbot-rules.js?v=20260915a";
...
async function rendreEnMarkdown(noeud, texte) {
  try {
    const { rendreMarkdown } = await import("./views/cours-reader.js?v=20260915a");
