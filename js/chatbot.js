 ...
 */
import { SUPABASE_URL, SUPABASE_KEY } from "./config.js?v=20260915d";
import { supabase } from "./db.js?v=20260915d";
import { icon } from "./icons.js?v=20260915d";
import { fenetreMessages, pageDepuisHash, extraireEvenements } from "./chatbot-rules.js?v=20260915d";
...
async function rendreEnMarkdown(noeud, texte) {
  try {
    const { rendreMarkdown } = await import("./views/cours-reader.js?v=20260915d");
