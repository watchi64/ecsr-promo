...
import { supabase } from "./db.js?v=20260819c";
import { icon } from "./icons.js?v=20260819c";
import { fenetreMessages, pageDepuisHash, extraireEvenements } from "./chatbot-rules.js?v=20260819c";
...
async function rendreEnMarkdown(noeud, texte) {
  try {
    const { rendreMarkdown } = await import("./views/cours-reader.js?v=20260819c");
