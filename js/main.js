 ...
 */
import { signInWithPassword, signUpWithPassword, getCurrentUser, invalidateCache } from "./db.js?v=20260810d";
import { toast } from "./utils.js?v=20260810d";
import { icon } from "./icons.js?v=20260810d";
import { initAuth, onAdminChange, isAuth, isAdmin, isProf } from "./auth-admin.js?v=20260810d";
import { loadAccent } from "./accent-switcher.js?v=20260810d";
import { loadTheme } from "./theme-switcher.js?v=20260810d";
import { renderHome } from "./views/home.js?v=20260810d";
import { renderDashboard } from "./views/dashboard.js?v=20260810d";
import { renderMonSuivi } from "./views/mon-suivi.js?v=20260810d";
import { renderPlanning, teardownPrintTarget, resetPlanningEditMode, requestPlanningToday } from "./views/planning.js?v=20260810d";
import { teardownDocPrint } from "./doc-officiel.js?v=20260810d";
import { renderNotes } from "./views/notes.js?v=20260810d";
import { renderRessources } from "./views/ressources.js?v=20260810d";
import { renderThemes } from "./views/themes.js?v=20260810d";
import { renderConfig } from "./views/config.js?v=20260810d";
import { renderCalendrier } from "./views/calendrier.js?v=20260810d";
import { initUndoKeyboard } from "./undo.js?v=20260810d";
import { renderNouveautes } from "./views/nouveautes.js?v=20260810d";
import { NOUVEAUTES } from "./nouveautes-data.js?v=20260810d";
import { visibles, nonLues, vuesEffectives, libellePastille } from "./nouveautes.js?v=20260810d";
